...
export default function ExportPopover({ projectId }: ExportPopoverProps) {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <div className='flex items-center gap-1.5 h-full px-3 cursor-pointer text-muted-foreground border-l hover:bg-accent/30 hover:text-foreground'>
          {getStatusIcon()}
